...
export type FeaturedPrestataire = {
  id: string;
...
export default function FeaturedProvidersClient({ prestataires }: { prestataires: FeaturedPrestataire[] }) {
  ...
  if (prestataires.length === 0) {
    return (
      <div
        ...
        className="flex flex-col items-center justify-center py-16 px-6 bg-white rounded-2xl shadow-card border border-rose-100 text-center max-w-2xl mx-auto"
      >
        ...
        <a
          href="/inscription"
          className="inline-flex items-center gap-2 text-white font-semibold px-8 py-3.5 rounded-full transition-all duration-150 shadow-sm hover:shadow-md hover:scale-[1.02] active:scale-[0.99]"
        ...
        return (
          ...
          >
            <Link
              ...
              className="group block bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-200 overflow-hidden flex flex-col h-full"
            >
