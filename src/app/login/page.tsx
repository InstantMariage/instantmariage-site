  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (authError) {
      if (authError.message === "Email not confirmed" || authError.code === "email_not_confirmed") {
        setError("Votre email n'est pas encore confirmé. Vérifiez vos emails (et spams) et cliquez sur le lien de confirmation.");
      } else {
    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          {/* Suggestion compte Google */}
          {showGoogleHint && (
            <div className="mb-4 rounded-xl border border-blue-200 bg-blue-50 px-4 py-4">
              <p className="text-sm font-medium text-blue-800 mb-1">
                Identifiants incorrects ou compte Google ?
              </p>
              <p className="text-sm text-blue-700 mb-3">
                Si vous avez créé votre compte avec Google, utilisez le bouton ci-dessous. Sinon, vérifiez votre mot de passe ou réinitialisez-le.
              </p>
              <button
                type="button"
                onClick={handleGoogleLogin}
                className="w-full flex items-center justify-center gap-2.5 rounded-xl py-3 px-4 text-sm font-semibold text-white transition-all duration-200 hover:opacity-90"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full border border-gray-300 rounded-xl px-4 py-3 text-base text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-rose-400 focus:border-rose-400 transition-all duration-200 bg-white"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  required
                  className="w-full border border-gray-300 rounded-xl px-4 py-3 pr-12 text-base text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-rose-400 focus:border-rose-400 transition-all duration-200 bg-white"
                />
                <button
                  type="button"
