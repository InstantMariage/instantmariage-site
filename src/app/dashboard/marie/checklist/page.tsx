...
const DEFAULT_CATEGORIES: Category[] = [
  {
    ...
    color: "#7C3AED",
    items: [
      { id: "18m-1", label: "Définir le budget global du mariage" },
      { id: "18m-2", label: "Choisir le type de cérémonie (civile / religieuse / laïque)" },
      { id: "18m-3", label: "Réserver le lieu de réception" },
      { id: "18m-4", label: "Préparer la liste complète des invités" },
      { id: "18m-5", label: "Choisir la destination du voyage de noces" },
      { id: "18m-6", label: "Réserver les billets d'avion / transport" },
      { id: "18m-7", label: "Réserver l'hébergement voyage de noces (hôtel, villa…)" },
      { id: "18m-8", label: "Vérifier la validité des passeports" },
      { id: "18m-9", label: "Obtenir les visas nécessaires" },
    ],
  },
  {
    id: "12mois",
    ...
    color: "#6366F1",
    items: [
      { id: "12m-1", label: "Réserver la mairie et déposer le dossier" },
      { id: "12m-2", label: "Signer le contrat de mariage chez le notaire" },
      { id: "12m-3", label: "Choisir et contacter les témoins" },
      { id: "12m-4", label: "Souscrire une assurance mariage" },
      { id: "12m-5", label: "Choisir et commander la robe de mariée" },
      { id: "12m-6", label: "Choisir la tenue du / de la marié(e)" },
      { id: "12m-7", label: "Réserver l'officiant laïque si besoin" },
      { id: "12m-8", label: "Choisir le traiteur et valider le menu" },
      { id: "12m-9", label: "Réserver le DJ / groupe de musique" },
      { id: "12m-10", label: "Commander et envoyer les faire-part" },
      { id: "12m-11", label: "Commander ou récupérer les alliances" },
    ],
  },
  {
    id: "6mois",
    ...
    color: "#EC4899",
    items: [
      { id: "6m-1", label: "Premier essayage de la robe" },
      { id: "6m-2", label: "Dégustation du menu" },
      { id: "6m-3", label: "Commander les fleurs et la décoration" },
      { id: "6m-4", label: "Commander le gâteau de mariage" },
      { id: "6m-5", label: "Réserver la coiffeuse et faire un essai" },
      { id: "6m-6", label: "Réserver la maquilleuse et faire un test" },
      { id: "6m-7", label: "Choisir les chaussures de mariage" },
      { id: "6m-8", label: "Choisir les bijoux et accessoires" },
      { id: "6m-9", label: "Choisir le voile ou couvre-chef" },
      { id: "6m-10", label: "Souscrire une assurance voyage" },
      { id: "6m-11", label: "Vérifier les vaccinations requises" },
    ],
  },
  {
    id: "3mois",
    ...
    color: "#F59E0B",
    items: [
      { id: "3m-1", label: "Gérer les RSVP et confirmer les présences" },
      { id: "3m-2", label: "Confirmer les allergies et régimes alimentaires" },
      { id: "3m-3", label: "Préparer le plan de table" },
      { id: "3m-4", label: "Organiser le transport (navettes, voitures)" },
      { id: "3m-5", label: "Réserver l'hébergement pour les invités" },
      { id: "3m-6", label: "Rédiger les vœux personnalisés" },
      { id: "3m-7", label: "Choisir les lectures et poèmes" },
      { id: "3m-8", label: "Sélectionner la musique de cérémonie" },
      { id: "3m-9", label: "Préparer le déroulé complet de cérémonie" },
      { id: "3m-10", label: "Organiser l'ordre de passage des témoins et discours" },
      { id: "3m-11", label: "Prévoir les animations (photobooth, jeux…)" },
      { id: "3m-12", label: "Commander les cadeaux pour les invités" },
      { id: "3m-13", label: "Prévoir le budget boissons et cocktail" },
      { id: "3m-14", label: "Préparer le livre d'or" },
      { id: "3m-15", label: "Choisir les tenues pour le voyage de noces" },
    ],
  },
  {
    id: "1mois",
    ...
    color: "#10B981",
    items: [
      { id: "1m-1", label: "Essayage final avec retouches" },
      { id: "1m-2", label: "Informer les prestataires des horaires définitifs" },
      { id: "1m-3", label: "Préparer les enveloppes de paiement prestataires" },
      { id: "1m-4", label: "Répétition de la cérémonie" },
      { id: "1m-5", label: "Prévoir la décoration de l'espace cérémonie" },
      { id: "1m-6", label: "Préparer la playlist et les morceaux clés" },
      { id: "1m-7", label: "Informer sa banque du voyage à l'étranger" },
      { id: "1m-8", label: "Prévoir les devises ou carte de change" },
    ],
  },
  {
    id: "semainej",
    ...
    color: "#F06292",
    items: [
      { id: "sem-1", label: "Confirmer les horaires avec tous les prestataires" },
      { id: "sem-2", label: "Préparer le planning horaire détaillé de la journée" },
      { id: "sem-3", label: "Désigner un responsable pour coordonner les prestataires" },
      { id: "sem-4", label: "Vérifier que les témoins sont informés et prêts" },
      { id: "sem-5", label: "Manucure / pédicure" },
      { id: "sem-6", label: "Préparer la pochette de survie (jour J)" },
      { id: "sem-7", label: "Préparer le kit urgence (épingles, sparadraps…)" },
      { id: "sem-8", label: "Charger téléphones, batteries et appareils photo" },
      { id: "sem-9", label: "Préparer les valises et liste de bagages" },
    ],
  },
  {
    id: "jourj",
    ...
    color: "#BE185D",
    items: [
      { id: "jourj-1", label: "Petit-déjeuner en famille ou avec les proches" },
      { id: "jourj-2", label: "Séance habillage et maquillage" },
      { id: "jourj-3", label: "Remise des bouquets et boutonnières" },
      { id: "jourj-4", label: "Profiter pleinement de chaque instant 💫" },
    ],
  },
  {
    id: "apres",
    ...
    color: "#14B8A6",
    items: [
      { id: "apres-1", label: "Envoyer les remerciements aux invités" },
      { id: "apres-2", label: "Récupérer et trier les photos et vidéos" },
      { id: "apres-3", label: "Changer son nom sur les documents officiels (si souhaité)" },
      { id: "apres-4", label: "Débriefer avec les prestataires" },
    ],
  },
];
