...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { path: "/demo/photographe", priority: 0.7, changeFrequency: "monthly" as const },
    { path: "/demo/boutique", priority: 0.7, changeFrequency: "monthly" as const },
    { path: "/demo/chauffeur", priority: 0.7, changeFrequency: "monthly" as const },
    { path: "/demo/salle", priority: 0.7, changeFrequency: "monthly" as const },
